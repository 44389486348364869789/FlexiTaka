    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "(ক) ব্যালেন্স ক্যাশ আউট (Cash Out): গ্রাহক তার প্রিপেইড সিম (GP, Robi, Banglalink) থেকে অফিশিয়াল USSD কোড ডায়াল করে আমাদের সিস্টেমে ব্যালেন্স ট্রান্সফার করেন এবং প্ল্যাটফর্ম ফি বাদ দিয়ে সমমূল্যের ক্যাশ টাকা সরাসরি bKash, Nagad বা ব্যাংকে গ্রহণ করেন।",
      ...
      },
      {
        ...
        content: [
          "FlexiTaka প্ল্যাটফর্মে প্রতি লেনদেনে সর্বনিম্ন সীমা ৳৫০.০০ এবং সর্বোচ্চ সীমা ৳৫০,০০০.০০।",
      ...
      },
      {
        ...
        content: [
          "নিরাপত্তা সতর্কতা: FlexiTaka কখনোই গ্রাহকের সিম পিন (SIM PIN), MyGP/MyRobi/MyBL পাসওয়ার্ড কিংবা টেলিকম এসএমএস OTP চাইবে না।",
          "অ্যাকাউন্ট ভেরিফিকেশনের জন্য শুধুমাত্র FlexiTaka প্ল্যাটফর্ম থেকে প্রেরিত ৬ ডিজিটের ওয়েব লগইন OTP প্রযোজ্য।",
        ],
      },
      {
        id: "payment",
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "(a) Cash Out Balance: Customers transfer excess prepaid mobile balance (GP, Robi, Banglalink) to designated numbers via official operator USSD dial codes, receiving spendable cash (bKash, Nagad, Bank) minus platform fees.",
      ...
      },
      {
        ...
        content: [
          "The minimum transaction amount supported is ৳50.00. The maximum transaction amount per order is ৳50,000.00.",
      ...
      },
      {
        ...
        content: [
          "Security Rule: FlexiTaka will NEVER ask for your SIM PIN, MyGP/MyRobi/MyBL account passwords, or telecom SMS verification codes.",
          "Only 6-digit platform OTP codes generated by FlexiTaka for account authentication should ever be entered on our website.",
        ],
      },
      {
        id: "payment",
